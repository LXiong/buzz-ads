...
(function(BS){
	...
	var self=this;
		...
		this.cityData=[
			{name:"hot",
			   items:[
					  ...
					  {title:"guangdong",name:"广东"},
					  {title:"jiangsu",name:"江苏"},
					  {title:"zhejiang",name:"浙江"}
			]},
			{name:"省/直辖市/自治区/特别行政区",
				   items:[
						  {title:"bejing",name:"北京"},
						  {title:"shanghai",name:"上海"},
						  {title:"guangdong",name:"广东"},
						  {title:"jiangsu",name:"江苏"},
						  {title:"zhejiang",name:"浙江"},
						  {title:"hainan",name:"海南"},
						  {title:"ningxia",name:"宁夏"},
						  {title:"anhui",name:"安徽"},
						  {title:"aomen",name:"澳门"},
						  {title:"chongqing",name:"重庆"},
						  {title:"fujian",name:"福建"},
						  {title:"gansu",name:"甘肃"},
						  {title:"guizhou",name:"贵州"},
						  {title:"guangxi",name:"广西"},
						  {title:"hebei",name:"河北"},
						  {title:"henan",name:"河南"},
						  {title:"hubei",name:"湖北"},
						  {title:"hunan",name:"湖南"},
						  {title:"heilongjiang",name:"黑龙江"},
						  {title:"jiangxi",name:"江西"},
						  {title:"jilin",name:"吉林"},
						  {title:"liaoning",name:"辽宁"},
						  {title:"neimeng",name:"内蒙"},
						  {title:"qinghai",name:"青海"},
						  {title:"sichuan",name:"四川"},
						  {title:"shanxi",name:"山西"},
						  {title:"shanxi",name:"陕西"},
						  {title:"shandong",name:"山东"},
						  {title:"tianjin",name:"天津"},
						  {title:"taiwan",name:"台湾"},
						  {title:"xinjiang",name:"新疆"},
						  {title:"xizang",name:"西藏"},
						  {title:"xianggang",name:"香港"},
						  {title:"yunnan",name:"云南"}
						  
			 ]}
		]
		//creak dom
		this.dom=$('<div class="dom"></div>');
		...
		this.cityDom=$('<span class="heading1">省/直辖市</span><div class="clear spacer10"></div><div class="cityDom left"><span class="cityCon"></span></div>').appendTo(this.dom);
