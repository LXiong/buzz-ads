...
/**
 * 功能：支付宝外部服务接口控制
 * 详细：该页面是请求参数核心处理文件，参数请不要做任何改动.
 * 版本：3.0 修改日期：2010-07-16
 * @author Jerry.Ma
 */
//CHECKSTYLE:OFF
...
public final class AlipayService {
     ...
     * @param it_b_pay
     *            超时时间，不填默认是15天。八个值可选：1h(1小时),2h(2小时),3h(3小时),1d(1天),3d(3天),7d(7天
     *            ),15d(15天),1c(当天)
     * @param input_charset
     ...
     * @return 请求URL
     */
    public static String createUrl(final String partner,
            final String seller_email, final String return_url,
            final String notify_url, final String show_url,
            final String out_trade_no, final String subject, final String body,
            final String total_fee, final String paymethod,
            final String defaultbank, final String encrypt_key,
            final String exter_invoke_ip, final String extra_common_param,
            final String buyer_email, final String royalty_type,
            final String royalty_parameters, final String it_b_pay,
            final String input_charset, final String key, final String sign_type) {
        ...
        String arg = AlipayBase.createLinkStringUrlEncode(sParaNew,
                input_charset);
        // 得到请求URL
     ...
     * @return 表单提交HTML文本
     */
    public static String buildPostform(final String partner,
            final String seller_email, final String return_url,
            final String notify_url, final String show_url,
            final String out_trade_no, final String subject, final String body,
            final String total_fee, final String paymethod,
        ...
        sbHtml.append("<input type=\"button\" name=\"v_action\" value=\"支付宝确认付款\" ")
            .append("onClick=\"document.forms['alipaysubmit'].submit();\">");
