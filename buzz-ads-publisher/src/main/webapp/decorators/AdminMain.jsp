...
<body style="background:#f9f9f9;">
    ...
    <div class="logoContainer">
        ...
        <div class="logoBg left noSpacer">
            <a class="bLink inlineBlock" href="${cxt_path}/admin/overview"><img class="logoImg" src="${image_path}/admax.png"/></a>
            <span class="logoTitle inlineBlock" style="position:relative;top:-4px;margin-left:0px;">后台管理</span>
        </div>
        <div class="menuBg fix">
            <div class="spacer15"></div>
            <sec:authorize ifAnyGranted="ROLE_AD_ADMIN">
                <%@ include file="/jsp/admin/MainAdmin.jsp"%>
            </sec:authorize>
        </div>
        <div class="clear"></div>
    </div>
