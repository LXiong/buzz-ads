...
<body style="background: #f9f9f9;">
    ...
    <div class="loginCon">
    	<sec:authorize ifAnyGranted="ROLE_USER">
            <span class="left welcome" >
                ...
                <font style="color:#6a6a6a; margin:0 10px;">|</font><span class="identity" id="identity">您的身份：<font style="color:#f60;">财务</font>
            	...
            	<span>
            		<sec:authorize ifAnyGranted="ROLE_AD_ADMIN,ROLE_PUBLISHER">
               		...
               		<sec:authorize ifAnyGranted="ROLE_ADVERTISER">
                   	    <a class="bLink"  href="${cxt_path}/advertiser/dashboard">广告商</a>
               		</sec:authorize> 
                </span>
            </span>
	...
	<div class="logoContainer">
        ...
        <div class="logoBg left">
            <a class="bLink inlineBlock" href="${cxt_path}/finance/settles"><img class="logoImg" src="${image_path}/logo.png"/></a>
            <span class="logoTitle inlineBlock" style="position:relative;top:-4px;margin-left:0px;">财务平台</span>
        </div>
        <div class="menuBg fix">
            <div class="spacer15"></div>
            <sec:authorize ifAnyGranted="ROLE_AD_FINANCE">
                <%@ include file="/jsp/finance/MainFinance.jsp"%>
            </sec:authorize>
        </div>
        <div class="clear"></div>
	</div>
