...
<div class="left" style="margin:0 5px;">
	<a id="leftmenu-admin-stats" class="menu-left-button" href="${cxt_path}/admin/overview">概览</a>
	<div class="clear spacer10"></div>
	<a id="leftmenu-admin-stats-site" class="menu-left-button" href="${cxt_path}/admin/sites">媒体统计</a>
    <div class="clear spacer10"></div>
