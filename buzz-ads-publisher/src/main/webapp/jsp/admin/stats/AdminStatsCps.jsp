...
<div class="container-body">
    ...
    <div class="container-right" style="overflow:auto;">
        ...
        <div class="overview" style="border-top:0px">
                ...
                <s:if test="#request.adminDailyStatistics != null && #request.adminDailyStatistics.size > 0">
                    <s:iterator value="#request.adminDailyStatistics" var="adminDailyStatistic" status="status">
                        <tr <s:if test="%{#status.odd}">style="background:#F2F6F9;"</s:if>>
                            ...
                            <td class="textRight">
                                <s:text name="global.format.number"><s:param value="%{#adminDailyStatistic.cpsViewNo}"/></s:text>
                            </td>
                            <td class="textRight">
                                <s:text name="global.format.number"><s:param value="%{#adminDailyStatistic.cpsClickNo}"/></s:text>
                            </td>
                            <td class="textRight">
                                <s:text name="global.format.number"><s:param value="%{#adminDailyStatistic.cpsOrderNo}"/></s:text>
                            </td>
                            <td class="textRight">¥${adminDailyStatistic.cpsPubCommissionDouble}</td>
                        </tr>
                    </s:iterator>
                </s:if>
                <s:else>
            ...
            <div class="clear spacer10"></div>
                <form action="${cxt_path}/admin/stats/cps" id="filterSearchForm" method="post">
