    ...
    <div class="container-right" style="overflow:auto;">
        <div class="overviewPanel shadow">
            <div class="dataSearch">
                <form action="cpc" method="get" id="statsForm">
        ...
        <div class="overview" style="border-top:0px">
                ...
                <s:if test="#request.adminDailyStatistics != null && #request.adminDailyStatistics.size > 0">
                    <s:iterator value="#request.adminDailyStatistics" var="adminDailyStatistic" status="status">
                        <tr <s:if test="%{#status.odd}">style="background:#F2F6F9;"</s:if>>
                            ...
                            <td class="textRight">
                                <s:text name="global.format.number"><s:param value="%{#adminDailyStatistic.cpcViewNo}"/></s:text>
                            </td>
                            <td class="textRight">
                                <s:text name="global.format.number"><s:param value="%{#adminDailyStatistic.cpcOriginalClickNo}"/></s:text>
                            </td><td class="textRight">
                                <s:text name="global.format.number"><s:param value="%{#adminDailyStatistic.cpcClickNo}"/></s:text>
                            </td><td class="textRight">
                               ${adminDailyStatistic.cpcCTR }
                            </td>
                            <td class="textRight">¥${adminDailyStatistic.cpcPubCommissionDouble}</td>
                        </tr>
                    </s:iterator>
                </s:if>
                <s:else>
            ...
            <div class="clear spacer10"></div>
                <form action="${cxt_path}/admin/stats/cpc" id="filterSearchForm" method="post">
