                ...
                <s:if test="#request.publisherDailyStatistics != null && #request.publisherDailyStatistics.size > 0">
                    <s:iterator value="#request.publisherDailyStatistics" var="publisherDailyStatistic" status="status">
                        <tr <s:if test="%{#status.odd}">style="background:#F2F6F9;"</s:if>>
                            ...
                            <td class="textRight">
                                <s:text name="global.format.number"><s:param value="%{#publisherDailyStatistic.cpcClickNo}"/></s:text>
                            </td>
                            <!--<td class="textRight">${publisherDailyStatistic.cpcClickToView}</td> -->
                            <td class="textRight">¥${publisherDailyStatistic.cpcPubCommissionDouble}</td>
                        </tr>
                    </s:iterator>
                </s:if>
                <s:else>
...
$(function() {
    ...
    $("#leftmenu-publisher-stats-cpc").addClass("active");
