...
<div class="container-body">
    ...
    <%@ include file="/jsp/publisher/stats/LeftMenu.jsp"%>
    <div class="container-right" style="overflow: auto;">
        <div class="overview">
            <div class="spacer10"></div>
            <p>本页合计总佣金：<font class="unit orange">¥</font><font class="orangeNumber">${request.totalPubCommissionDouble}</font></p>
            <div class="spacer10 clear"></div>
        </div>
        <div class="clear spacer15"></div>
        <div class="overviewPanel shadow">
            <div class="dataSearch formDate">
                <form action="stats" method="get" id="statsForm">
...
$(function() {
    ...
    //menu active
	$("#topmenu-publisher-stats").addClass("active");
    $("#leftmenu-publisher-stats-overview").addClass("active");
