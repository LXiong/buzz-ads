...
<div class="container-body">
	...
	<div>
		<%@ include file="/jsp/publisher/settings/LeftMenu.jsp"%>
		<div class="container-right" style="overflow:auto;">
		   ...
		   <div class="overview noBT">
	            ...
	            <table class="viewTable">
                    ...
                    <tr>
                        <td style="width:100px;vertical-align: middle;">收款银行：<td>
                        <td>
	                ...
	                <tr>
                        ...
                        <s:else>
	                    <td><input id="submit" class="bButton center lightOrange" type="button" value="修改" /> <input class="bButton center" style="margin-left: 20px;" type="button" value="返回" onclick="document.location='${cxt_path}/publisher/home'" /></td>
	                    </s:else>
	                </tr>
	            </table>
		   </div>
...
$(function(){
    ...
    $("#submit").click(function(){
        ...
        $.ajax({
            type: "POST",
            url: "${cxt_path}/publisher/settings/update",
            dataType: "json",
            data: "publisher.name=" + name + "&publisher.mobile=" + mobile + "&publisher.qq=" + qq + "&publisher.email="
                    ...
                    + receiveBank + "&publisher.receiveBankCode=" + receiveBankCode,
            success: function(callback){
                if(callback.success){
                    displayStatusMessage("保存或修改成功");
                    setTimeout(function(){window.location.href='${cxt_path}/publisher/settings';},1000);
                }else{
    ...
    //menu active
    $("#topmenu-publisher-settings").addClass("active");
    $("#leftmenu-publisher-settings-accountInfo").addClass("active");
});
</script>
