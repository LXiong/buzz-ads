...
public class UpYunUtil {
	private static SimpleDateFormat formater = new SimpleDateFormat("EEE, d MMM yyyy HH:mm:ss 'GMT'", Locale.US);
	...
	* return 签名字符串
	*/
	public static String sign(String method, String uri, String date, long length, String username, String password){
