 ...
 * the next action.
 *
 * NOTE: The action you are redirecting to needs to be configured with a result of name="input"
 * since the added messages will trigger the 'workflow' interceptor to return a result of "input"
 * 
 * @author zyeming
 * 
 */
public class RedirectMessageInterceptor extends MethodFilterInterceptor {
    ...
    private static final long serialVersionUID = 4622565424244763303L;
    ...
    protected void before(ActionInvocation invocation,
        ...
        Collection<String> actionErrors =
            (Collection<String>) session.remove(ACTION_ERRORS_KEY);
        ...
        Collection<String> actionMessages =
            (Collection<String>) session.remove(ACTION_MESSAGES_KEY);
        ...
        Map<String, List<String>> fieldErrors =
            (Map<String, List<String>>) session.remove(FIELD_ERRORS_KEY);
