 ...
 * belonging to the current application. The <code>service</code> URL is monitored by the 
...
public class CasAuthenticationEntryPoint implements AuthenticationEntryPoint, InitializingBean {
    ...
    /** Used to identify client source. */
    ...
    /**
     * Constructs the Url for Redirection to the CAS server.  Default implementation relies on the CAS client 
    ...
    protected String createRedirectUrl(final String serviceUrl) {
        return CommonUtils.constructRedirectUrl(this.loginUrl, this.serviceProperties.getServiceParameter(), 
                serviceUrl, this.serviceProperties.isSendRenew(), false) + "&" + SOURCE + "=" + source;
    }
